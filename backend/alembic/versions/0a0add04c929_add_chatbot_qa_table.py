"""Add chatbot QA table

Revision ID: 0a0add04c929
Revises: b2c3d4e5f6a7
Create Date: 2026-05-13 18:39:18.630049
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('keywords', sa.ARRAY(sa.String(length=100)), nullable=True),
        sa.Column('category', sa.String(length=100), nullable=True),
        sa.Column('quick_replies', sa.ARRAY(sa.String(length=100)), nullable=True),
    ...
    # Create indexes
    op.create_index('idx_chatbot_qa_keywords', 'chatbot_qa', ['keywords'], unique=False, postgresql_using='gin')
    op.create_index('idx_chatbot_qa_category', 'chatbot_qa', ['category'], unique=False)
    op.create_index('idx_chatbot_qa_active', 'chatbot_qa', ['is_active'], unique=False)
...
def downgrade() -> None:
    op.drop_index('idx_chatbot_qa_active', table_name='chatbot_qa')
    op.drop_index('idx_chatbot_qa_category', table_name='chatbot_qa')
    op.drop_index('idx_chatbot_qa_keywords', table_name='chatbot_qa')
    op.drop_table('chatbot_qa')
