...
// Generate slug with DB uniqueness check is handled server-side.
// This local version is kept only for local UI preview (no DB check).
export async function generateUniqueSlug(_unused, length = 10) {
